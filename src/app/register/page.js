...
export default function RegisterPage() {
  ...
  return (
    <main className="min-h-screen bg-[#f7f5f0] flex relative overflow-hidden">
      ...
      <div
        className="blob w-[400px] h-[400px] bg-[#fff3c4] bottom-[5%] right-[0%]"
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-4 sm:p-8 relative z-10">
        <div
          className="w-full max-w-[460px] animate-slide-up"
            ...
            <form onSubmit={(e) => e.preventDefault()} className="space-y-4">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full bg-[#f7f5f0] border-2 border-[#eae5d9] text-[#1e1b26] placeholder-[#8f8a9e] rounded-2xl pl-11 pr-4 py-3 text-sm font-medium focus:border-[#f04e7c] focus:outline-none transition-colors"
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full bg-[#f7f5f0] border-2 border-[#eae5d9] text-[#1e1b26] placeholder-[#8f8a9e] rounded-2xl pl-11 pr-11 py-3 text-sm font-medium focus:border-[#f04e7c] focus:outline-none transition-colors"
                  />
                  <button
                    type="button"
                    onClick={() => setShowPassword(!showPassword)}
                    className="absolute right-4 top-1/2 -translate-y-1/2 text-[#8f8a9e] hover:text-[#1e1b26]"
                  >
                    {showPassword ? (
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <select
                    ...
                    className="w-full bg-[#f7f5f0] border-2 border-[#eae5d9] text-[#1e1b26] rounded-2xl pl-11 pr-10 py-3 text-sm font-medium focus:border-[#f04e7c] focus:outline-none transition-colors appearance-none cursor-pointer"
                  >
              ...
              <label className="flex items-start gap-3 cursor-pointer pt-1">
                <input
                  ...
                  className="w-4 h-4 rounded border-2 border-[#eae5d9] accent-[#f04e7c] mt-0.5"
                />
                <span className="text-sm text-[#5a5566]">
                  I agree to the{" "}
                  <a href="#" className="text-[#f04e7c] font-semibold">
                    Terms of Service
                  </a>{" "}
                  and{" "}
                  <a href="#" className="text-[#f04e7c] font-semibold">
              ...
              <button
                type="submit"
                className="btn-brutal w-full text-center mt-2"
              >
                Create Account
              </button>
            </form>
