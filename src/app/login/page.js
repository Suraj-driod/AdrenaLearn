...
export default function LoginPage() {
  ...
  return (
    <main className="min-h-screen bg-[#f7f5f0] flex items-center justify-center relative overflow-hidden px-6">
      ...
      <div className="blob w-[400px] h-[400px] bg-[#fff3c4] bottom-[10%] right-[8%]" style={{ animationDelay: '2s' }} />
      ...
      <div className="relative z-10 w-full max-w-[440px] animate-slide-up">
        <div className="bg-white rounded-[40px] border-2 border-[#eae5d9] p-8 sm:p-10 shadow-[0_10px_30px_rgba(0,0,0,0.04)]">
          ...
          <div className="text-center mb-8">
            <Link href="/" className="font-[Outfit] text-3xl font-black text-[#1e1b26] inline-block mb-3">adrenalinal</Link>
            <h1 className="font-[Outfit] text-2xl font-bold">Welcome Back 👋</h1>
            <p className="text-[#5a5566] text-sm mt-1">Sign in to continue your quest</p>
          </div>

          <form onSubmit={(e) => e.preventDefault()} className="space-y-5">
            {/* Email */}
            <div>
              <label className="block text-sm font-semibold text-[#1e1b26] mb-1.5">Email Address</label>
            ...
            {/* Password */}
            <div>
              <label className="block text-sm font-semibold text-[#1e1b26] mb-1.5">Password</label>
              <div className="relative">
                ...
                />
                <button type="button" onClick={() => setShowPassword(!showPassword)} className="absolute right-4 top-1/2 -translate-y-1/2 text-[#8f8a9e] hover:text-[#1e1b26] transition-colors">
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center gap-2 cursor-pointer group">
                <input type="checkbox" checked={remember} onChange={() => setRemember(!remember)} className="w-4 h-4 rounded border-2 border-[#eae5d9] accent-[#f04e7c]" />
                <span className="text-sm text-[#5a5566] group-hover:text-[#1e1b26] transition-colors">Remember me</span>
              </label>
              <a href="#" className="text-sm text-[#f04e7c] hover:text-[#d9406a] font-semibold transition-colors">Forgot password?</a>
            </div>
          ...
          <div className="flex items-center gap-4 my-6">
            ...
            <span className="text-xs text-[#8f8a9e] font-semibold">or continue with</span>
            <div className="flex-1 h-[2px] bg-[#eae5d9]" />
          </div>
          ...
          <p className="text-center text-sm text-[#5a5566] mt-6">
            ...
            <Link href="/register" className="text-[#f04e7c] hover:text-[#d9406a] font-bold transition-colors">Create one free</Link>
          </p>
        </div>
      </div>
    </main>
